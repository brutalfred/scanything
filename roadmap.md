# Scanything all-in-one roadmap

## Done (this wave)
- Split mode picker into two menus: **Scan** (photo, video, resale, document, authenticate, history) and **Tools**.
- QR / barcode reader (native BarcodeDetector + ZXing fallback, product lookup links).
- In-app gallery (IndexedDB) with view, scan, edit, share, save, delete.
